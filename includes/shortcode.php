    ...
    <div class="poc-cards-viewport">
        ...
        <div class="flip-card-inner">
            ...
            <div class="flip-card-front">
                ...
                <button class="flip-button poc-flip-btn" data-flip-trigger="1">↩️ Rückseite anzeigen</button>
            ...
            <div class="flip-card-back">
                ...
                <?php // Share buttons ?>
                <?php
                $share_text = rawurlencode( 'Ich habe gerade die Aktionskarten der Pioneers of Change gespielt. Und eine silberne/goldene Karte zum Thema "' . $title . '" erhalten! Interesse? Hier gibt\'s mehr Infos zum Spiel - mich hat es sehr für die nächsten Schritte motiviert! https://act.pioneersofchange.org/' );
                ?>
...
add_shortcode( 'poc_cards_list', function ( $atts ) {
    ...
    <div class="poc-list-card" data-post-id="<?php echo esc_attr( $post_id ); ?>" data-cat="<?php echo esc_attr( $cat_slug ); ?>">
        ...
        <div class="poc-list-card-bar"></div>
